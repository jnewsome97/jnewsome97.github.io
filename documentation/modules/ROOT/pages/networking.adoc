...
[source,bash,role="execute"]
----
bash madopssupport/create-net-projects.sh
----
...
[source,bash,role="execute"]
----
bash madopssupport/test-connectivity.sh
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f madopssupport/network-policy-block-all.yaml
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f madopssupport/network-policy-allow-all-from-netproj-a.yaml
----
