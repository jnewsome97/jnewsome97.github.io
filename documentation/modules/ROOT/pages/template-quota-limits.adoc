...
[source,bash,role="execute"]
----
cat madopssupport/project_request_template.yaml
----
...
[source,bash,role="execute"]
----
oc create -f madopssupport/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="execute"]
----
oc apply -f madopssupport/cr_project_request.yaml -n openshift-config
----
