...
* Designing Developer Environments in **OpenShift**
...
**Flexibility is key**—participants can explore modules in any order. Some sections have prerequisites, but you can start with Admin Operations or jump to RHACM and RHACS. **Discover value** in the Ops Track of the Modern App Development Roadshow.
